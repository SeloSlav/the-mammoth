...
export {
  ...
  expandSwingDoorFirearmParkedLeafAabb,
  ...
  swingDoorSwingingLeafEnclosingAabb,
  ...
  SWING_DOOR_FIREARM_PARKED_LEAF_UNIFORM_PAD_M,
  SWING_DOOR_HITSCAN_CLOSED_NORMAL_HALF_EXTRA_M,
  SWING_DOOR_HITSCAN_CLOSED_TANGENT_PAD_M,
  SWING_DOOR_INTERACT_RADIUS_M,
  SWING_DOOR_INTERACT_FEET_ABOVE_HEAD_SLACK_M,
  SWING_DOOR_INTERACT_FEET_BELOW_SLACK_M,
