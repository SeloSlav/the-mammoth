...
| [architecture/fp-world-npc-readiness.md](architecture/fp-world-npc-readiness.md) | **NPCs in Mamutica: not ready** — combat sim only today; checklist before live building spawns |
