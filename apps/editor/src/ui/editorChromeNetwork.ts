...
export async function postSaveApartmentKit(json: string): Promise<string> {
  const path = "/__editor/save-apartment-kit";
  const res = await fetch(path, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ json }),
...
export async function postSaveFloor19CorridorBuiltins(json: string): Promise<string> {
  const path = "/__editor/save-floor-19-corridor-builtins";
  const res = await fetch(path, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ json }),
...
export async function postSaveApartmentUnitLayoutProfiles(json: string): Promise<string> {
  const path = "/__editor/save-apartment-unit-layout-profiles";
  const res = await fetch(path, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ json }),
