...
import {
  ...
  subscribeFpSessionCompassHeading,
} from "../game/fpSession/fpSessionCompassHeading";
import {
  THEME_CARD_BORDER,
  THEME_CARD_BG,
  THEME_TEXT_FAINT,
...
export function MammothCompassHud() {
  ...
  useEffect(() => {
    ...
    const apply = (): void => {
      const heading = getFpSessionCompassHeadingRad();
    ...
    apply();
    return subscribeFpSessionCompassHeading(apply);
  }, []);
