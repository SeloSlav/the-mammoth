...
import GameTimeTickStepReducer from "./game_time_tick_step_reducer";
...
import FishTankEcosystemRow from "./fish_tank_ecosystem_table";
import FishTankFilterLinkRow from "./fish_tank_filter_link_table";
import FishTankFilterStarterGrantRow from "./fish_tank_filter_starter_grant_table";
import FlashlightChargeRow from "./flashlight_charge_table";
import GameTimeScheduleRow from "./game_time_schedule_table";
...
import PlayerMissionProgressRow from "./player_mission_progress_table";
...
import PlayerWeaponChamberCacheRow from "./player_weapon_chamber_cache_table";
...
const tablesSchema = __schema({
  ...
  apartment_unit_utilities: __table({
    name: 'apartment_unit_utilities',
    indexes: [
      { name: 'unit_key', algorithm: 'btree', columns: [
        'unitKey',
      ] },
    ...
    constraints: [
      { name: 'apartment_unit_utilities_unit_key_key', constraint: 'unique', columns: ['unitKey'] },
    ],
  }, ApartmentUnitUtilitiesRow),
  ...
  fish_tank_ecosystem: __table({
    name: 'fish_tank_ecosystem',
    indexes: [
      { name: 'tank_decor_id', algorithm: 'btree', columns: [
        'tankDecorId',
      ] },
    ],
    constraints: [
      { name: 'fish_tank_ecosystem_tank_decor_id_key', constraint: 'unique', columns: ['tankDecorId'] },
    ],
  }, FishTankEcosystemRow),
  fish_tank_filter_link: __table({
    name: 'fish_tank_filter_link',
    indexes: [
      { name: 'filter_decor_id', algorithm: 'btree', columns: [
        'filterDecorId',
      ] },
    ],
    constraints: [
      { name: 'fish_tank_filter_link_filter_decor_id_key', constraint: 'unique', columns: ['filterDecorId'] },
    ],
  }, FishTankFilterLinkRow),
  fish_tank_filter_starter_grant: __table({
    name: 'fish_tank_filter_starter_grant',
    indexes: [
      { name: 'filter_decor_id', algorithm: 'btree', columns: [
        'filterDecorId',
      ] },
    ...
    constraints: [
      { name: 'fish_tank_filter_starter_grant_filter_decor_id_key', constraint: 'unique', columns: ['filterDecorId'] },
    ],
  }, FishTankFilterStarterGrantRow),
  ...
  game_time_schedule: __table({
    name: 'game_time_schedule',
    indexes: [
      { name: 'scheduled_id', algorithm: 'btree', columns: [
        'scheduledId',
      ] },
    ...
    constraints: [
      { name: 'game_time_schedule_scheduled_id_key', constraint: 'unique', columns: ['scheduledId'] },
    ],
  }, GameTimeScheduleRow),
  ...
  player_mission_progress: __table({
    ...
    constraints: [
      { name: 'player_mission_progress_identity_key', constraint: 'unique', columns: ['identity'] },
    ],
  }, PlayerMissionProgressRow),
  player_pose: __table({
    name: 'player_pose',
    indexes: [
      { name: 'identity', algorithm: 'btree', columns: [
  ...
  player_weapon_chamber_cache: __table({
    name: 'player_weapon_chamber_cache',
    indexes: [
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
    ...
    constraints: [
      { name: 'player_weapon_chamber_cache_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, PlayerWeaponChamberCacheRow),
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("apply_fish_filter_patch", ApplyFishFilterPatchReducer),
  __reducerSchema("balcony_grow_tick_step", BalconyGrowTickStepReducer),
  __reducerSchema("bind_fish_tank_filter", BindFishTankFilterReducer),
  ...
  __reducerSchema("game_time_tick_step", GameTimeTickStepReducer),
  ...
  __reducerSchema("npc_tick_step", NpcTickStepReducer),
  ...
  __reducerSchema("rinse_fish_tank_filter", RinseFishTankFilterReducer),
